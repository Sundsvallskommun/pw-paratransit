...
public class Denial {
	...
	public static String mockDenialAddDecision(final String caseId, final String scenarioName, final String requiredScenarioState) {
		final var stateAfterGet = mockCaseDataGet(caseId, scenarioName, requiredScenarioState,
		...
		final var stateAfterAddStakeholder = mockCaseDataAddStakeholderPatch(caseId, scenarioName, stateAfterGet,
		...
		final var stateAfterGetStakeholder = mockCaseDataStakeholdersGet(caseId, "2", scenarioName, stateAfterAddStakeholder,
			"automatic_denial_decision-task-worker---api-casedata-get-stakeholder");

		final var stateAfterRenderPdf = mockRenderPdf(scenarioName, stateAfterGetStakeholder, "automatic_denial_add-message-to-errand-task-worker---api-templating-render-pdf",
			equalToJson("""
							{
		...
		return mockCaseDataDecisionPatch(caseId, scenarioName, stateAfterRenderPdf,
